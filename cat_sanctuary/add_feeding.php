...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($error)) {
        try {
            $stmt = $pdo->prepare("INSERT INTO DailyCare (catID, caretakerID, Date, FeedingTime, FoodType, FoodAmount, Behavior, Grooming, Notes) 
                                 VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
            $stmt->execute([
                $_POST['catID'],
                $_POST['caretakerID'],
            ...
            $success = "Feeding record added successfully";
...
<head>
    ...
    <title>Add Feeding Record - Cat Sanctuary</title>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="FoodType" name="FoodType" maxlength="50" required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="FoodAmount">Food Amount (grams)</label>
                                <input type="number" id="FoodAmount" name="FoodAmount" step="0.01" required>
                            </div>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea id="Behavior" name="Behavior" rows="3"></textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="checkbox-container">
                                <input type="checkbox" id="Grooming" name="Grooming" value="1">
